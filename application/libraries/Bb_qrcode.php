...
{
	var $cacheable = true;
	var $cachedir = 'assets/qrcode/img';
	var $errorlog = 'assets/qrcode/log';
	var $quality = true;
	var $size = 1024;
	...
	public function initialize($config = array()) {
		...
		include "assets/qrcode/qrconst.php";
		include "assets/qrcode/qrtools.php";
		include "assets/qrcode/qrspec.php";
		include "assets/qrcode/qrimage.php";
		include "assets/qrcode/qrinput.php";
		include "assets/qrcode/qrbitstream.php";
		include "assets/qrcode/qrsplit.php";
		include "assets/qrcode/qrrscode.php";
		include "assets/qrcode/qrmask.php";
		include "assets/qrcode/qrencode.php";
	}
