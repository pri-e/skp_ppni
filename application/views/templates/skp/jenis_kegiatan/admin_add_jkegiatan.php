              ...
              <?php echo form_open('skp/simpan_jkegiatan','id="form_custom" class="form-horizontal form-label-left"' );?>
                <div class="form-group">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <textarea id="nama_kegiatan" class="form-control col-md-7 col-xs-12" rows="3" name="nama_kegiatan" required="required"></textarea>
                  </div>
                </div>
                <div class="form-group">
                  <label for="quota_peserta" class="control-label col-md-3 col-sm-3 col-xs-12">Quota Peserta<span class="required">*</span></label>
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <input id="quota_peserta" class="form-control col-md-7 col-xs-12" type="text" name="quota_peserta" required="required">
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <input type="text" id="last-name" name="tgl_kegiatan" required="required" class="datepicker form-control col-md-7 col-xs-12">
                  </div>
                </div>
                <div class="form-group">
                  <label for="no_skp" class="control-label col-md-3 col-sm-3 col-xs-12">NO SKP PPNI<span class="required">*</span></label>
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <input id="no_skp" class="form-control col-md-7 col-xs-12" type="text" name="no_skp" required="required">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <input id="tempat_keg" name="tempat_keg" class="form-control col-md-7 col-xs-12" required="required" type="text">
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <input id="ketua_keg" name="ketua_keg" class="form-control col-md-7 col-xs-12" required="required" type="text">
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <input id="nira_ketua_keg" name="nira_ketua_keg" class="form-control col-md-7 col-xs-12" required="required" type="text">
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <input id="nama_legist" name="nama_legist" class="form-control col-md-7 col-xs-12" required="required" type="text">
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <input id="legist_jabatan" name="legist_jabatan" class="form-control col-md-7 col-xs-12" required="required" type="text">
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <input id="legist_daerah" name="legist_daerah" class="form-control col-md-7 col-xs-12" required="required" type="text">
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <input id="legist_nira" name="legist_nira" class="form-control col-md-7 col-xs-12" required="required" type="text">
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <textarea id="keterangan" class="form-control col-md-7 col-xs-12" rows="3" name="keterangan" ></textarea>
                  </div>
                </div>
                <div class="form-group">
                ...
                <div>
                  <input type="hidden" name="id_jenis_kegiatan" id="id_jenis_kegiatan" value=""/>
