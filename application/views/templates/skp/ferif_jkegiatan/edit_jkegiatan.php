      ...
      <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
          <div class="x_panel">
            ...
            <div class="x_content">
              <?php echo form_open('ferifikasi_admin/save_ferifikasi','id="form_custom" class="form-horizontal form-label-left"' );?>
                ...
                <div class="form-group">
                  <label for="ferif_admin" class="control-label col-md-3 col-sm-3 col-xs-12">Ferifikasi Admin<span class="required">*</span>
                  </label>
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <select name="ferif_admin" class="form-control" id="ferif_admin">
                    <?php if (!empty($item->verif_admin)) {?>
                      <option value="<?php echo $item->verif_admin;?>"><?php echo $item->verif_admin;?></option>";
                      <option value="Di Setujui">Di Setujui</option>
                      <option value="Tidak Disetujui">Tidak Disetujui</option>
                    <?php }else{?>                      
                      <option value="">-Pilih Status Ferifikasi-</option>";
                      <option value="Di Setujui">Di Setujui</option>
                      <option value="Tidak Disetujui">Tidak Disetujui</option>
                    <?php }?>
                    </select>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <p>Sebelum di ferifikasi Pastikan semua Field Terisi Dan Benar<br>Jika Fitur registrasi online di aktifkan, silahkan isikan keterangan contact person, transfer biaya no rekening di Field Keterangan
                ...
                <div>
                  ...
                  <input type="hidden" name="id_instansi" id="id_instansi" value="<?php echo $item->id_instansi?>"/>
