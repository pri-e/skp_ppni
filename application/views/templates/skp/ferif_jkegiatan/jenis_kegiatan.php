              ...
              <table id="datatable-buttons" class="table table-striped table-bordered">
                <thead>
                  <tr>
                    ...
                    <th style=text-align:center >REG ONLINE</th>
                      ...
                      <?php if ($item->verif_admin==TRUE) {?>
                        <?php if ($item->status=="Aktif") {?>
                          ...
                          <td class="bg-success" style=text-align:center>
                            <a href="<?php echo base_url();?>index.php/ferifikasi_admin/proses_ferif/<?php echo $this->myencryption->encode($item->id_jenis_kegiatan);?>" class="btn btn-xs btn-warning" role="button"><span class="fa fa-pencil"></span> Verifikasi</a>
                            <a href="<?php echo base_url();?>index.php/ferifikasi_admin/proses_ferif/<?php echo $this->myencryption->encode($item->id_jenis_kegiatan);?>" class="btn btn-xs btn-danger" role="button"><span class="fa fa-trash"></span> Hapus</a>
                          </td>
                        <?php }else{ ?>
                          <td><?php echo $no++;?></td>
