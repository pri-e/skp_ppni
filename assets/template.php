                                ...
                                <ul class="nav side-menu">
                                    <li><a><i class="fa fa-home"></i> Home <span class="fa fa-chevron-down"></span></a>
                                        <ul class="nav child_menu">
                                            <li><?php echo anchor('welcome/dashboard1', 'Dashboard 1'); ?> </li>
                                    </li>
                                    <li><?php echo anchor('welcome/dashboard2', 'Dashboard 2'); ?> </li>
                                    </li>
                                    <li><?php echo anchor('welcome/dashboard3', 'Dashboard 3'); ?> </li>
                                </ul>
                                </li>
                                <li><a><i class="fa fa-edit"></i> Forms <span class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu">
                                        <li><?php echo anchor('welcome/form_general', 'General Form'); ?> </li>
                                        <li><?php echo anchor('welcome/form_advanced', 'Advanced Components'); ?> </li>
                                        <li><?php echo anchor('welcome/form_validation', 'Form Validation'); ?> </li>
                                        <li><?php echo anchor('welcome/form_wizard', 'Form Wizard'); ?> </li>
                                        <li><?php echo anchor('welcome/form_upload', 'Form Upload'); ?> </li>
                                        <li><?php echo anchor('welcome/form_button', 'Form Button'); ?> </li>
                                    </ul>
                                </li>
